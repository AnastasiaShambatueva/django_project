# Generated by Django 4.2.1 on 2025-06-22 05:49
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('designer', '0003_article_delete_dataupload_delete_pagecontent_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('site_title', models.CharField(default='UX_UI_designer Hub', max_length=200)),
                ('site_description', models.TextField(default='Comprehensive UX_UI_designer profession')),
                ('footer_text', models.TextField(default='Студент: Шамбатуева Анастасия Михайловна | Группа: РИ-231003 | Курс: Технологии программирования на Python')),
                ('profession_keywords', models.TextField(default='UX_UI_designer, UX, UI, designer', help_text='Keywords for identifying UX_UI_designer positions (comma-separated)')),
